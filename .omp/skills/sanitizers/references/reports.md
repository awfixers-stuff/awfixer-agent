...
**Diagnosis:** Frame `#0` in the first stack is where the OOB write happened (line 12). The allocation was at line 8 with size 40 bytes. Access is 0 bytes _after_ the region end — classic off-by-one.
