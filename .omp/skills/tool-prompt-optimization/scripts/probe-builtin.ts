...
import { toolWireSchema } from "@awfixerai/ai";
import { Settings } from "@awfixerai/agent/config/settings";
import { BUILTIN_TOOLS, GithubTool, HIDDEN_TOOLS, IrcTool, type Tool, type ToolFactory, type ToolSession } from "@awfixerai/agent/tools";
