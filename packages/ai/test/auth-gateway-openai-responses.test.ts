...
import { encodeResponse, encodeStream, parseRequest } from "@awfixerai/ai/providers/openai-responses-server";
import type { AssistantMessage } from "@awfixerai/ai/types";
