...
import { clearCustomApis, getCustomApi } from "@awfixerai/ai/api-registry";
import {
	createMockModel,
	isMockModel,
	MOCK_API,
	...
	registerMockApi,
	streamMock,
} from "@awfixerai/ai/providers/mock";
import type { AssistantMessage, AssistantMessageEvent, Context, ToolCall } from "@awfixerai/ai/types";
