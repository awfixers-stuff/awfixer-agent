...
import type { ResponseCreateParamsStreaming, ResponseInput } from "@awfixerai/ai/providers/openai-responses-wire";
import {
...
import type { Model, ModelSpec, OpenAICompat } from "@awfixerai/ai/types";
