...
Model catalog for [awfixer-agent](https://github.com/awfixers-stuff/awfixer-agent): bundled model database, provider discovery, model identity, classification, and equivalence.
...
Import from subpaths (`@awfixerai/catalog/<module>`) or the root barrel.
