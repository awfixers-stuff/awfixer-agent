...
import MODELS_JSON from "@awfixerai/catalog/models.json" with { type: "json" };
import { buildXaiOAuthStaticSeed } from "@awfixerai/catalog/provider-models/openai-compat";
