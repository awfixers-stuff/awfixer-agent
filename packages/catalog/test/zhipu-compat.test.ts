...
import { buildOpenAICompat } from "@awfixerai/catalog/compat/openai";
import { zhipuCodingPlanModelManagerOptions } from "@awfixerai/catalog/provider-models/openai-compat";
