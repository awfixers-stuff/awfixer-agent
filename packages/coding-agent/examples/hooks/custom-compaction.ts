 ...
 *
 * Usage:
 *   agent --hook examples/hooks/custom-compaction.ts
 */

import type { HookAPI } from "@awfixerai/agent";
import { convertToLlm, serializeConversation } from "@awfixerai/agent";
import { complete, getModel } from "@awfixerai/ai";
