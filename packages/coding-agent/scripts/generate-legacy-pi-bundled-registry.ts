 ...
 * `agent-legacy-bundled:` virtual namespace.
 *
...
const PACKAGES: readonly BundledPackage[] = [
	{ dir: "packages/agent", name: "@awfixerai/agent-core", identifier: "PiAgentCore", rootShim: null },
	{
		dir: "packages/ai",
		name: "@awfixerai/ai",
		identifier: "PiAi",
	...
	{ dir: "packages/natives", name: "@awfixerai/natives", identifier: "PiNatives", rootShim: null },
	{ dir: "packages/tui", name: "@awfixerai/tui", identifier: "PiTui", rootShim: null },
	{ dir: "packages/utils", name: "@awfixerai/utils", identifier: "PiUtils", rootShim: null },
];
...
interface RegistryEntry {
	/** Canonical registry key, e.g. `@awfixerai/ai/oauth`. */
	readonly key: string;
	 ...
	 * is the canonical `@awfixerai/<pkg>/<subpath>` string Bun resolves via the
...
async function collectEntries(): Promise<RegistryEntry[]> {
	...
	for (const pkg of PACKAGES) {
		...
		// remaps to `@awfixerai/ai/oauth/anthropic`, covered by pi-ai's
