...
import { APP_NAME, getProjectDir } from "@awfixerai/utils";
...
async function handleInstall(
	...
	if (packages.length === 0) {
		...
		console.error(chalk.dim(`  ${APP_NAME} plugin install @awfixerai/exa`));
...
${chalk.bold("Examples:")}
  ${APP_NAME} plugin install @awfixerai/exa[search]
