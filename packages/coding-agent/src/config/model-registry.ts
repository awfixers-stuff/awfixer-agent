...
import { registerCustomApi, unregisterCustomApis } from "@awfixerai/ai/api-registry";
import type {
	Api,
	Context,
	Model,
...
import type { AssistantMessageEventStream } from "@awfixerai/ai/utils/event-stream";
import { buildModel } from "@awfixerai/catalog/build";
import { isVertexExpressOpenAIUrl } from "@awfixerai/catalog/hosts";
import { readModelCache } from "@awfixerai/catalog/model-cache";
import {
	createModelManager,
	type ModelManagerOptions,
	type ModelRefreshStrategy,
} from "@awfixerai/catalog/model-manager";
import { getBundledModels, getBundledProviders } from "@awfixerai/catalog/models";
import {
	googleAntigravityModelManagerOptions,
	googleGeminiCliModelManagerOptions,
	openaiCodexModelManagerOptions,
	PROVIDER_DESCRIPTORS,
} from "@awfixerai/catalog/provider-models";
import {
	collapseBuiltModelVariants,
	getVariantAliasSources,
	resolveVariantAlias,
} from "@awfixerai/catalog/variant-collapse";
...
import type { ApiKeyResolver, FetchImpl } from "@awfixerai/ai";
import { registerOAuthProvider, unregisterOAuthProviders } from "@awfixerai/ai/oauth";
import type { OAuthCredentials, OAuthLoginCallbacks } from "@awfixerai/ai/oauth/types";
import {
...
import { isBunTestRuntime, isRecord, logger } from "@awfixerai/utils";
