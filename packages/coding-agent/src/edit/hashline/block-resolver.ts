 ...
 * primitive in `@awfixerai/natives`, which infers the language from the file
 ...
 */
import type { BlockResolver } from "@awfixerai/hashline";
import { blockRangeAt } from "@awfixerai/natives";
