...
import { HL_FILE_PREFIX, HL_FILE_SUFFIX, HL_MOVE_KEYWORD, HL_REM_KEYWORD } from "@awfixerai/hashline";
import type { Component } from "@awfixerai/tui";
import { sliceWithWidth, visibleWidth, wrapTextWithAnsi } from "@awfixerai/tui";
