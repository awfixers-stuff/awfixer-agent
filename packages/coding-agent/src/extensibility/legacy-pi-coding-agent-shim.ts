 ...
 * `@awfixerai/agent` (or one of its aliased scopes like
 ...
 * the same module identity as a direct `@awfixerai/agent` import.
 */

import type { AgentToolUpdateCallback } from "@awfixerai/agent-core";
import type { TSchema } from "@awfixerai/ai";
import { parseFrontmatter as parseOmpFrontmatter } from "@awfixerai/utils";
