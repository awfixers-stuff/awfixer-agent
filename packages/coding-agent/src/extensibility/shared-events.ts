...
import type { CompactionPreparation, CompactionResult } from "@awfixerai/agent-core/compaction";
import type { ImageContent, TextContent, ToolResultMessage } from "@awfixerai/ai";
