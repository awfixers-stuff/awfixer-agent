...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@awfixerai/ai";
import { isPersonalGitHubCopilotBaseUrl } from "@awfixerai/catalog/wire/github-copilot";
...
// Per-provider image-count budgets live in @awfixerai/snapcompact
