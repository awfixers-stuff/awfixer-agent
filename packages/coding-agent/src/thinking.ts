import { type ResolvedThinkingLevel, ThinkingLevel } from "@awfixerai/agent-core";
import { Effort, type Model, THINKING_EFFORTS } from "@awfixerai/ai";
import { clampThinkingLevelForModel, getSupportedEfforts } from "@awfixerai/catalog/model-thinking";
