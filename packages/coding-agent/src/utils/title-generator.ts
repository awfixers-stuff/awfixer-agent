...
import { type Api, type AssistantMessage, completeSimple, type Model, type Tool } from "@awfixerai/ai";
import { isTerminalHeadless, logger, prompt } from "@awfixerai/utils";
