...
import * as autoThinkingClassifier from "@awfixerai/agent/auto-thinking/classifier";
...
import { AUTO_THINKING, clampAutoThinkingEffort, resolveProvisionalAutoLevel } from "@awfixerai/agent/thinking";
