...
import { buildSpec, type CompletionSpec, generateCompletion } from "@awfixerai/agent/cli/completion-gen";
import type { CliConfig, CommandCtor } from "@awfixerai/utils/cli";
