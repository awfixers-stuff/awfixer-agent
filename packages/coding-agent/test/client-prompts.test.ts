...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@awfixerai/agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@awfixerai/agent/mcp/types";
