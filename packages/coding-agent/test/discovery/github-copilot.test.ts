...
import { loadCapability, setDisabledProviders } from "@awfixerai/agent/capability";
import type { ContextFile } from "@awfixerai/agent/capability/context-file";
import { clearCache } from "@awfixerai/agent/capability/fs";
import type { Instruction } from "@awfixerai/agent/capability/instruction";
import type { Prompt } from "@awfixerai/agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@awfixerai/agent/capability/rule";
import { RuleProtocolHandler } from "@awfixerai/agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@awfixerai/utils";
import "@awfixerai/agent/capability/context-file";
import "@awfixerai/agent/capability/instruction";
import "@awfixerai/agent/capability/prompt";
import "@awfixerai/agent/capability/rule";
import "@awfixerai/agent/discovery/github";
