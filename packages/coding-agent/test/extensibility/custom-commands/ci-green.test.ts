...
import * as piCodingAgent from "@awfixerai/agent";
import { GreenCommand } from "@awfixerai/agent/extensibility/custom-commands/bundled/ci-green";
...
import type * as TypeBox from "@awfixerai/agent/extensibility/typebox";
