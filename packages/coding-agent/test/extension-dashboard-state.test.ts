...
import { applyDisabledExtensionsToState } from "@awfixerai/agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@awfixerai/agent/modes/components/extensions/types";
