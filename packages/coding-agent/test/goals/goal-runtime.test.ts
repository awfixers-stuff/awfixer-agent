...
} from "@awfixerai/agent/goals/runtime";
import type { Goal, GoalModeState, GoalRuntimeEvent, GoalTokenUsage } from "@awfixerai/agent/goals/state";
import { escapeXmlText } from "@awfixerai/utils";
