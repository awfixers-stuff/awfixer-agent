...
import { commands, isSubcommand, resolveCliArgv } from "@awfixerai/agent/cli-commands";
import { looksLikeLocalPath } from "@awfixerai/agent/commands/install";
...
describe("looksLikeLocalPath", () => {
	...
	test("npm specs and marketplace refs are remote", () => {
		expect(looksLikeLocalPath("@awfixerai/exa")).toBe(false);
