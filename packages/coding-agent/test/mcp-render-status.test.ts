...
import { renderMCPResult } from "@awfixerai/agent/mcp/render";
import { DeferredMCPTool, MCPTool, type MCPToolDetails } from "@awfixerai/agent/mcp/tool-bridge";
import type { MCPServerConnection, MCPToolDefinition, MCPTransport } from "@awfixerai/agent/mcp/types";
import { ToolExecutionComponent } from "@awfixerai/agent/modes/components/tool-execution";
import { theme as activeTheme, getThemeByName, initTheme } from "@awfixerai/agent/modes/theme/theme";
import { formatOutputNotice, type OutputMeta } from "@awfixerai/agent/tools/output-meta";
import { formatStatusIcon } from "@awfixerai/agent/tools/render-utils";
import type { AgentTool } from "@awfixerai/agent-core";
import type { TSchema } from "@awfixerai/ai";
import { TUI } from "@awfixerai/tui";
