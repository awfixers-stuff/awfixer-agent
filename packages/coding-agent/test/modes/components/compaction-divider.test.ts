...
import { CompactionSummaryMessageComponent } from "@awfixerai/agent/modes/components/compaction-summary-message";
import { initTheme } from "@awfixerai/agent/modes/theme/theme";
import { createCompactionSummaryMessage } from "@awfixerai/agent-core/compaction";
