...
import { PluginManager } from "@awfixerai/agent/extensibility/plugins";
import { type InstalledPluginSummary, MarketplaceManager } from "@awfixerai/agent/extensibility/plugins/marketplace";
...
} from "@awfixerai/agent/modes/components/plugin-settings";
