...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@awfixerai/agent/session/messages";
import type { CustomMessageEntry } from "@awfixerai/agent/session/session-entries";
