...
import { runOnboardingSetup } from "@awfixerai/agent/commands/setup";
import { Settings } from "@awfixerai/agent/config/settings";
import { SETTINGS_SCHEMA } from "@awfixerai/agent/config/settings-schema";
import {
	ALL_SCENES,
	...
	type SetupSceneHost,
	selectSetupScenes,
} from "@awfixerai/agent/modes/setup-wizard";
import { WebSearchTab } from "@awfixerai/agent/modes/setup-wizard/scenes/web-search";
import { SetupWizardComponent } from "@awfixerai/agent/modes/setup-wizard/wizard-overlay";
...
import { SEARCH_PROVIDER_OPTIONS, SEARCH_PROVIDER_PREFERENCES } from "@awfixerai/agent/web/search/types";
