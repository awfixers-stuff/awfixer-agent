...
} from "@awfixerai/agent/slash-commands/builtin-registry";
import { CollabQrCodeComponent } from "@awfixerai/agent/slash-commands/helpers/collab-qrcode";
import { Spacer } from "@awfixerai/tui";
