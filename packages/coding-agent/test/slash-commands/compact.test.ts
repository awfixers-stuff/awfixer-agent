...
import type { CompactOptions } from "@awfixerai/agent/extensibility/extensions/types";
import type { InteractiveModeContext } from "@awfixerai/agent/modes/types";
import type { CompactMode } from "@awfixerai/agent/session/compact-modes";
import {
	ACP_BUILTIN_SLASH_COMMANDS,
	executeAcpBuiltinSlashCommand,
} from "@awfixerai/agent/slash-commands/acp-builtins";
import { executeBuiltinSlashCommand } from "@awfixerai/agent/slash-commands/builtin-registry";
import type { SlashCommandRuntime } from "@awfixerai/agent/slash-commands/types";
