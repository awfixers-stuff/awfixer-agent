...
import type { StatusLineSegmentId } from "@awfixerai/agent/config/settings-schema";
import { StatusLineComponent } from "@awfixerai/agent/modes/components/status-line";
import type { SegmentContext } from "@awfixerai/agent/modes/components/status-line/segments";
import { renderSegment } from "@awfixerai/agent/modes/components/status-line/segments";
import { initTheme, theme } from "@awfixerai/agent/modes/theme/theme";
import { getSessionAccentAnsi, getSessionAccentHex } from "@awfixerai/agent/utils/session-color";
import { visibleWidth } from "@awfixerai/tui";
import { getProjectDir, setProjectDir } from "@awfixerai/utils";
