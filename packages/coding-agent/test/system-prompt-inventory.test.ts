...
import { buildSystemPrompt as buildSdkSystemPrompt } from "@awfixerai/agent/sdk";
import {
	buildSystemPrompt,
	DEFAULT_SYSTEM_PROMPT_TOOL_NAMES,
	type SystemPromptToolMetadata,
} from "@awfixerai/agent/system-prompt";
import type { Tool } from "@awfixerai/agent/tools";
