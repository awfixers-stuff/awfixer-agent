...
import { LSP_READONLY_ACTIONS } from "@awfixerai/agent/lsp";
import {
	type ApprovalMode,
	...
	resolveApproval,
	truncateForPrompt,
} from "@awfixerai/agent/tools/approval";
import { BashTool } from "@awfixerai/agent/tools/bash";
import { DEBUG_READONLY_ACTIONS } from "@awfixerai/agent/tools/debug";
import type { AgentTool, ToolApproval } from "@awfixerai/agent-core";
