...
import { handleArxiv } from "@awfixerai/agent/web/scrapers/arxiv";
import { handleIacr } from "@awfixerai/agent/web/scrapers/iacr";
import { handlePubMed } from "@awfixerai/agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@awfixerai/agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@awfixerai/agent/web/scrapers/types";
