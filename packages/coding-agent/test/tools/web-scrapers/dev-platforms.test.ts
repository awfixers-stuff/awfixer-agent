...
import { handleDevTo } from "@awfixerai/agent/web/scrapers/devto";
import { handleGitLab } from "@awfixerai/agent/web/scrapers/gitlab";
import { handleHackerNews } from "@awfixerai/agent/web/scrapers/hackernews";
import { handleLobsters } from "@awfixerai/agent/web/scrapers/lobsters";
