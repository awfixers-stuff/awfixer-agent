...
import { handleArtifactHub } from "@awfixerai/agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@awfixerai/agent/web/scrapers/coingecko";
import { handleDiscogs } from "@awfixerai/agent/web/scrapers/discogs";
