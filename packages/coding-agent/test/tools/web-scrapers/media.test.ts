...
import { handleHuggingFace } from "@awfixerai/agent/web/scrapers/huggingface";
import { handleSpotify } from "@awfixerai/agent/web/scrapers/spotify";
import { handleVimeo } from "@awfixerai/agent/web/scrapers/vimeo";
