...
import { handleAur } from "@awfixerai/agent/web/scrapers/aur";
import { handleBrew } from "@awfixerai/agent/web/scrapers/brew";
import { handleMaven } from "@awfixerai/agent/web/scrapers/maven";
import { handleNuGet } from "@awfixerai/agent/web/scrapers/nuget";
import { handlePackagist } from "@awfixerai/agent/web/scrapers/packagist";
import { handleRubyGems } from "@awfixerai/agent/web/scrapers/rubygems";
