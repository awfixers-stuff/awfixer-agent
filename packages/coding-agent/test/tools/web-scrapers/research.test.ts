...
import { handleBiorxiv } from "@awfixerai/agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@awfixerai/agent/web/scrapers/openlibrary";
import { handleWikidata } from "@awfixerai/agent/web/scrapers/wikidata";
