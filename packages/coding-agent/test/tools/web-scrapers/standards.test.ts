...
import { handleCheatSh } from "@awfixerai/agent/web/scrapers/cheatsh";
import { handleRfc } from "@awfixerai/agent/web/scrapers/rfc";
import { handleTldr } from "@awfixerai/agent/web/scrapers/tldr";
