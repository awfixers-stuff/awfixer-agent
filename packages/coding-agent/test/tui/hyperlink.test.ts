...
import { LocalProtocolHandler } from "@awfixerai/agent/internal-urls/local-protocol";
...
import {
	...
	urlHyperlink,
	urlHyperlinkAlways,
} from "@awfixerai/agent/tui/hyperlink";
import * as terminalCaps from "@awfixerai/tui";
