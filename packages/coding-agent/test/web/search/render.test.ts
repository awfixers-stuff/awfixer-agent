...
import { renderSearchResult, type SearchRenderDetails } from "@awfixerai/agent/web/search/render";
import type { SearchResponse } from "@awfixerai/agent/web/search/types";
