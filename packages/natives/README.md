...
```typescript
import { grep, find, encodeSixel } from "@awfixerai/natives";
...
`@awfixerai/natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @awfixerai/natives-<platform>-<arch>
