...
```ts
import { renderMany, frames, resolveShape } from "@awfixerai/snapcompact";
...
```ts
import { compact } from "@awfixerai/snapcompact";
...
- [Monorepo README](https://github.com/awfixers-stuff/awfixer-agent#readme)
