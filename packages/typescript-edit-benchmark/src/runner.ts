...
import { formatSessionDumpText, RpcClient } from "@awfixerai/agent";
import type { AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@awfixerai/agent-core";
import type { Model, ToolExample } from "@awfixerai/ai";
import { formatHashlineHeader, InMemorySnapshotStore } from "@awfixerai/hashline";
...
const CLI_PATH = Bun.fileURLToPath(import.meta.resolve("@awfixerai/agent/cli"));
