...
from autoawfixer.db import Database, IssueState, issue_key
from autoawfixer.git_ops import GitCommandError, HeadDriftError
from autoawfixer.github_backend import GitHubBackend
from autoawfixer.github_client import GitHubError, IssueInfo, PullRequestFileInfo, RepoInfo
...
def ensure_workspace_dependencies(bindings: ToolBindings) -> None:
    ...
    (``@awfixerai/pi-*``) only exist after an install, so without one any
