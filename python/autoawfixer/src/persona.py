...
from autoawfixer.sandbox import Workspace
...
def _load(name: str) -> str:
    return resources.files("autoawfixer.prompts").joinpath(name).read_text(encoding="utf-8")
...
def dirty_state_reminder(
    *,
    ...
    leaves changes behind that autoawfixer would otherwise discard. The summary
