"""Client half of the autoawfixer ↔ gh-proxy channel.
...
routing clone/fetch/push through the proxy too — autoawfixer never holds the PAT.
...
from autoawfixer.git_ops import GitCommandError, HeadDriftError, PushResult
...
class GitHubProxyClient:
    """HMAC-signed REST client speaking to a `autoawfixer.proxy.server` instance.
