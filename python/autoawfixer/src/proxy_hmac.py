"""Shared HMAC signing/verification for the autoawfixer ↔ gh-proxy channel.

Autoawfixer signs every request to gh-proxy with an HMAC-SHA256 over
...
# Headers on every autoawfixer→gh-proxy request.
HEADER_TIMESTAMP = "X-Autoawfixer-Timestamp"  # unix seconds, integer string
HEADER_SIGNATURE = "X-Autoawfixer-Sig"  # hex-encoded HMAC-SHA256
