...
// Inline nav glyphs — autoawfixer has no icon library.
    ...
    <aside class="rmp-rail">
      ...
      <div class="rmp-rail-brand">
        ...
        <span class="rmp-rail-wordmark">
          <span class="rmp-rail-name">autoawfixer</span>
      ...
      <nav class="rmp-nav">
        {NAV.map((item) => (
          <button
            ...
            title={item.locked ? "Triage — locked (set AUTOAWFIXER_REPLAY_TOKEN to enable)" : item.label}
