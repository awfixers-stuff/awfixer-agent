...
Typed Python bindings for the `agent --mode rpc` protocol used by the coding agent.
...
- typed startup options for common `agent --mode rpc` flags such as thinking level,
